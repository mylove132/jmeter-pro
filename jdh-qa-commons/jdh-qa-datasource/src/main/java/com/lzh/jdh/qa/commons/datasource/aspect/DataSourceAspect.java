package com.lzh.jdh.qa.commons.datasource.aspect;
import com.lzh.jdh.qa.commons.datasource.config.DataSourceContextHolder;
...
public class DataSourceAspect {
    ...
    @Pointcut("!@annotation(com.lzh.jdh.qa.commons.datasource.annotation.Master) " +
